...
#linc-bot-hud{position:fixed;z-index:2147483647;
  background:#0d1117f2;
  border:1px solid #3a465c;border-radius:12px;padding:14px 18px 16px 18px;
...
.lb-sec{font-size:16px;font-weight:700;color:#7ec8ff;letter-spacing:2px;margin-bottom:-4px;border-bottom:1px solid #2c3648;padding-bottom:3px}
